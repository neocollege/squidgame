    ...
    private void submitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_submitMouseClicked
        ...
        if(!Username.isEmpty() && !pass.isEmpty()){
            ...
            try {
                ...
                ps = con.prepareStatement("select password from players where player_no = ?");
                ps.setInt(1, UN);
                ...
                Logger.getLogger(playerLogin.class.getName()).log(Level.SEVERE, null, ex);
            }
            
            if(pass.equals(passgot)){
                try {
                    String fname = null;
                    ps = con.prepareStatement("select fname from players where player_no = ?");
                    ps.setInt(1, UN);
                    ResultSet rs = ps.executeQuery();
                    while(rs.next()){
                    ...
                    playerScreen screen = new playerScreen(fname, UN);
